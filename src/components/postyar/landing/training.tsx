...
const STEPS: { icon: any; title: string; intro: string; points: string[] }[] = [
  ...
  },
  {
    icon: PlusCircleIcon,
    title: "افزودن کانال",
    intro: "یک کانال یا گروه تلگرام، باله یا روبیکا را به‌عنوان مقصد انتشار اضافه کنید.",
    points: [
      "از منوی داشبورد به بخش «کانال‌ها» یا «مقصد» بروید.",
      "روی «افزودن کانال جدید» کلیک کنید و پلتفرم را انتخاب کنید.",
      "توکن بات را از BotFather تلگرام یا سامانهٔ مشابه باله/روبیکا دریافت و در فرم وارد کنید.",
  ...
  },
  {
    icon: BotIcon,
    title: "بات‌ساز",
    intro: "بدون کدنویسی، بات تلگرام، باله یا روبیکا بسازید و گردش کار واقعی تعریف کنید.",
    points: [
      ...
      "اقدامات «ارسال فاکتور باله»، «نمایش کیف پول»، «پایش طلا» و «پشتیبانی» را متصل کنید.",
  ...
  },
  {
    ...
    points: [
      ...
      "روش پرداخت را انتخاب کنید: کارت بانکی، درگاه، یا بات باله.",
