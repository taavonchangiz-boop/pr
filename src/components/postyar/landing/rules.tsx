...
const SECTIONS: { icon: any; title: string; items: string[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "سامانهٔ زمان‌بندی جلالی با دقت دقیقه‌ای اجرا می‌شود؛ اختلال در ارسال به‌دلیل قطعی پلتفرم مقصد (تلگرام، باله، روبیکا) قابل گذشت است.",
  ...
  },
  {
    ...
    items: [
      ...
      "پرداخت‌ها از طریق کارت بانکی، درگاه و بات باله قابل انجام است؛ فرایند پرداخت با تأیید سمت-سرور مبلغ انجام می‌شود.",
  ...
  },
  {
    ...
    items: [
      ...
      "سامانه مسئول کیفیت سرویس‌های third-party (تلگرام، باله، روبیکا، درگاه بانکی) نیست.",
